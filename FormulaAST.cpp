...
namespace ASTImpl {
    ...
    public:
        ...
        virtual double Evaluate(const std::function<CellInterface::Value(Position)>& func) const = 0;
    ...
    namespace {
        ...
        public:
            ...
            double Evaluate(const std::function<CellInterface::Value(Position)>& func) const override {
        ...
        public:
            ...
            double Evaluate(const std::function<CellInterface::Value(Position)>& func) const override {
                CellInterface::Value result = func(*cell_);
...
double FormulaAST::Execute(const std::function<CellInterface::Value(Position)>& func) const {
